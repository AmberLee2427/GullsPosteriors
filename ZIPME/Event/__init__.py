...
class Event:
    ...
    def get_magnification(self, t, obs=None, pp=None):
        ...
        ss = np.sqrt(
            (x2 - x1) ** 2 + (y2 - y1) ** 2
        )  # i don't know that this is strictly necessary since they are always opposite
        ...
        # print('Debug Event.get_magnification: ss1', ss1, type(ss1), ss1.shape)
        # print('Debug Event.get_magnification: ss2', ss2, type(ss2), ss2.shape)
