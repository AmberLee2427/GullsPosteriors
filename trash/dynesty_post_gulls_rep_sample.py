...
for i in range(nevents):
    ...
    sate = mm.satelliteskycoord.SatelliteSkyCoord(
        ephemerides_file, satellite="Roman"
    )
    coords = astrocoords.SkyCoord(
        ra=ra, dec=dec, unit=(u.deg, u.deg), frame="icrs", obstime="J2000"
    )
